...
echo ''
seabatch_statement "- On your system your home directory is:"
echo ''
seabatch_statement "$HOME_DIRECTORY"
echo ''
seabatch_statement "- Therefore your SeaBatch directory will be:"
echo ''
seabatch_statement "$SEABATCH_DIRECTORY"
echo ''
seabatch_statement "- Do you wish to continue the installation?"
echo ''
...
SEABATCH_SUB_DIRECTORY=${SEABATCH_DIRECTORY}'/.sub'
SEABATCH_REPO=${SEABATCH_SUB_DIRECTORY}'/seabatch2.0_repo'

seabatch_statement "Step 2 of 5: Clone The Remote SeaBatch Repository"
echo ''
seabatch_statement "- SeaBatch 2.0 is stored in a remote repository (repo) located at https://github.com/michaelbrown/seabatch2.0_repo."
echo ''
seabatch_statement "- It is necessary to clone the above remote repo into your SeaBatch directory. This will allow you to easily keep up to date with any improvements to SeaBatch 2.0."
echo ''
seabatch_statement "- NOTE: In order to clone the above remote repo into your SeaBatch directory you must have git (http://git-scm.com/) installed and be connected to the internet."
echo ''
seabatch_statement "- NOTE: The above remote repo will be cloned into a hidden (.) directory named \".sub\" in your SeaBatch directory."
echo ''
seabatch_statement "- Do you wish to continue the installation?"
echo ''
seabatch_statement "- If YES, then the above remote repo will be cloned into your SeaBatch directory."
echo ''
seabatch_statement "- If NO, then the installation will be quit."
...
#mkdir $SEABATCH_SUB_DIRECTORY

#git clone BLAH $SEABATCH_SUB_DIRECTORY
...
if [ -e ~/.bashrc ]; then
	...
	seabatch_statement "- Do you wish to continue the installation?"
	echo ''
	seabatch_statement "- If YES, then the above command will be entered."
	echo ''
	seabatch_statement "- If NO, then the installation will be quit."
...
if [ $? -eq 0 ]; then
	...
	seabatch_statement "- Do you wish to continue the installation?"
	echo ''
	seabatch_statement "- If YES, then the above commands will be entered."
	echo ''
	seabatch_statement "- If NO, then the installation will be quit."
